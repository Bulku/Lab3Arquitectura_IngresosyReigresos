...
class MateriaResourceIT {
    ...
    private static final Long DEFAULT_CREDITOS = 1L;
    private static final Long UPDATED_CREDITOS = 2L;
    ...
    public static Materia createEntity(EntityManager em) {
        Materia materia = new Materia().nombre(DEFAULT_NOMBRE).creditos(DEFAULT_CREDITOS);
        return materia;
    }
    ...
    public static Materia createUpdatedEntity(EntityManager em) {
        Materia materia = new Materia().nombre(UPDATED_NOMBRE).creditos(UPDATED_CREDITOS);
        return materia;
    }
    ...
    void getAllMaterias() throws Exception {
        ...
        restMateriaMockMvc
            ...
            .andExpect(jsonPath("$.[*].creditos").value(hasItem(DEFAULT_CREDITOS.intValue())));
    }
    ...
    void getMateria() throws Exception {
        ...
        restMateriaMockMvc
            ...
            .andExpect(jsonPath("$.creditos").value(DEFAULT_CREDITOS.intValue()));
    }
    ...
    void putExistingMateria() throws Exception {
        ...
        updatedMateria.nombre(UPDATED_NOMBRE).creditos(UPDATED_CREDITOS);
    ...
    void partialUpdateMateriaWithPatch() throws Exception {
        ...
        partialUpdatedMateria.nombre(UPDATED_NOMBRE).creditos(UPDATED_CREDITOS);
