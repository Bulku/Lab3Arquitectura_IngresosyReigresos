...
import { getEntities, reset } from './pensum.reducer';
...
export const Pensum = () => {
  ...
  const totalItems = useAppSelector(state => state.pensum.totalItems);
  const links = useAppSelector(state => state.pensum.links);
  const entity = useAppSelector(state => state.pensum.entity);
  ...
  return (
    <div>
      <h2 id="pensum-heading" data-cy="PensumHeading">
        <Translate contentKey="arqui3RealApp.pensum.home.title">Pensums</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="arqui3RealApp.pensum.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/pensum/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="arqui3RealApp.pensum.home.createLabel">Create new Pensum</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={pensumList ? pensumList.length : 0}
          next={handleLoadMore}
          ...
          {pensumList && pensumList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="arqui3RealApp.pensum.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('numero')}>
                    <Translate contentKey="arqui3RealApp.pensum.numero">Numero</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="arqui3RealApp.pensum.home.notFound">No Pensums found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
