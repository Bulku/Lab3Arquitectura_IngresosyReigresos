...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pensum.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PENSUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PENSUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PENSUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PENSUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PENSUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PENSUM actions', async () => {
      const expectedActions = [
        {
