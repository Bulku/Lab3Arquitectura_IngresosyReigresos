...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ingreso-estudiante.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGRESOESTUDIANTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INGRESOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INGRESOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INGRESOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INGRESOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INGRESOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
