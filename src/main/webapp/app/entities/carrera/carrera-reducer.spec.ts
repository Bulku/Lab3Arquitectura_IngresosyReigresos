...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './carrera.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARRERA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARRERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARRERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARRERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARRERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARRERA actions', async () => {
      const expectedActions = [
        {
